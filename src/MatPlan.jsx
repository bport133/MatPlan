...
const SYLLABUS_SEED = [
  ...
  ["Neutral Position", "Neutral - Offense", "Front Headlock", null, { s: "INSTRUCTION", why: "The front headlock is a critical core position — critical to the success of a good wrestler." }],
  ...
  ["Neutral Position", "Neutral - Offense", "Ankle Pick", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Arm Drag", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Back Step Drills - Headlock", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Offense", "Clearing the Collar Tie", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Clearing Ties", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Cradle From Standing", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Defending High Crotch On Feet", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Defending High Crotch on Mat", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Defending Single Leg on the Mat", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Defending the Cement Job or Cowboy", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Desperation Down by 1 or 2", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Desperation Down by 3 or More", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Firemans Carry", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Front Headlock on Mat Finish", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Front Headlock to Cradle Drill", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Offense", "Getting Angles on Takedowns", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Handfighting", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Handfighting Defense", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "High Crotch Crackdown", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "High Crotch Crackdown Finish on Mat", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "High Crotch Finishing High", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "High Single Leg", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Inside Trip", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Knee Pick", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Low Single Leg", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Offensive Tie-Up Positions", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Penetration Step", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Russian 2 on 1", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Shot Build Up Drills", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Offense", "Single Leg", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Single Leg Mat Finish", ["Elbow to the Mat", "Pinch Shoulder to Thigh w/ Tight Grip", "Circle to Back Side with Still-Tight Shoulder + Grip", "Lift Leg as You Circle to Create Hamstring Pressure", "Elbow to the Mat w/ Limp Arm", "Pinch Shoulder to Thigh", "Walk to Corner and Iowa", "Limp Arm and Attack Ankle"], { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Stance & Motion", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Standing Headlock", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Sweep Single Leg", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Throw By", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "Turk & Low Leg Cradle", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Offense", "What are the Basic Takedowns", null, { s: "INSTRUCTION" }],
  ...
  ["Neutral Position", "Neutral - Base", "Position & Balance Drills", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Base", "Position Drils Stance", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Base", "Position Focus", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Base", "Proper Penetration Drills", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Base", "Shadow Wrestling / Motion", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Base", "Stance", null, { s: "INSTRUCTION" }],
  ...
  ["Neutral Position", "Neutral - Counter Offence", "Block, Snap, and Spin", ["Block with Combo of Hands, Thumbs, Forearm, Head", "Snap Collar Tie and Inside Control Through the Hole", "Cover Head and Shoulder", "On Toes", "Back Arm with Bent Wrist to Prevent Crayfish", "Hip Heist", "Attack Hooks or Ankles", "Bump to Finish"], { s: "INSTRUCTION" }],
  ...
  ["Neutral Position", "Neutral - Counter Offence", "Clearing a Collar Tie", null, { s: "INSTRUCTION", why: "Dominating the center of the mat has become increasingly important under newer rules — a wrestler must know how to react and clear a tie-up the moment they lose position." }],
  ["Neutral Position", "Neutral - Counter Offence", "Clearing a Two-on-One", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Counter Offence", "Clearing an Underhook", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Counter Offence", "Clearing Straight Arms", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Counter Offence", "Clearing a Wrist Tie", null, { s: "INSTRUCTION" }],
  ...
  ["Neutral Position", "Neutral - Counter Offence", "Countering High Crotch Drill", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Counter Offence", "Re-Shot", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Clearing a Front Headlock", null, { s: "INSTRUCTION", err: "A wrestler needs a few different ways to clear a tie — expect a fight, and be ready to chain two, three, or four motions together to get it done." }],
  ...
  ["Neutral Position", "Neutral - Defense", "Block - Circle", ["Block with Head, Hands, Forearm", "Ciricle", "Don't be a Target"], { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Defend Double Leg", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Defend Front Headlock", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Defend High Crotch", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Defend Single Leg", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Defend the Front Headlock Standing Position", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Defense", "Defending Front Headlock Drills", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Defense", "Defending High Crotch", null, { s: "INSTRUCTION" }],
  ...
  ["Neutral Position", "Neutral - Set-Ups / Control Ties", "Outside Step Arm Drag", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Set-Ups / Control Ties", "Set-Ups", null, { s: "INSTRUCTION" }],
  ["Neutral Position", "Neutral - Set-Ups / Control Ties", "Under Hook Finish Drill", null, { s: "DRILL" }],
  ["Neutral Position", "Neutral - Set-Ups / Control Ties", "Underhook", null, { s: "INSTRUCTION" }],
  // ===================== TOP POSITION =====================
  ...
  ["Top Position", "Top - Breakdowns", "Breakdowns", ["ADD"], { s: "INSTRUCTION" }],
  ["Top Position", "Top - Breakdowns", "Waist and Far Ankle", null, { s: "INSTRUCTION" }],
  ...
  ["Top Position", "Top - Turns & Pinning Combinations", "2 on 1 Tilt Set-Up", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Arm Bar (Top Turn)", ["Base", "Belly", "Wrist"], { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Arm Bar Tilt", ["Base", "Belly"], { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Arm Bar w/ 1 on 1", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Arm Bar w/ Half", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Cradle", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Far Side/Cross Face Cradle - From Iowa/Cradle Ride", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Half Nelson - From Base", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Half Nelson - From Belly", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Near Side Cradle - From Iowa/Cradle Ride", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Short Arm Bar", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Tight Waist & Half Nelson", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Tilt", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Turk & Low Leg Cradle", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Wrist & Cradle", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Wrist & Half Nelson", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Turns & Pinning Combinations", "Wrist & Short Arm Bar", null, { s: "INSTRUCTION" }],
  ...
  ["Top Position", "Top - Rides & Controls", "Collar Tie", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Cradle Ride - Iowa", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Getting Legs in Drills", null, { s: "DRILL" }],
  ["Top Position", "Top - Rides & Controls", "Leg Offense", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Leg Riding", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Leg Wrestling", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Reaction Drill", null, { s: "DRILL" }],
  ["Top Position", "Top - Rides & Controls", "Returning Opponent From Stand-Up", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Riding Drills", null, { s: "DRILL" }],
  ["Top Position", "Top - Rides & Controls", "Riding Position", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Riding Skills", null, { s: "INSTRUCTION" }],
  ["Top Position", "Top - Rides & Controls", "Top Drills", null, { s: "INSTRUCTION" }],
  ...
  ["Bottom Position", "Bottom - Base", "Base Building", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Base", "Base Building Drills", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Base", "Clearing Wrists", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Base", "Holding Base", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Base", "Holding Your Base Drills", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Base", "Referees Position", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Base", "Sealing Off", null, { s: "INSTRUCTION" }],
  ...
  ["Bottom Position", "Bottom - Defense", "Clearing Crab Ride", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defend Arm Bar", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defend Far Side Cradle", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defend Half Nelson", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defend Nearside Cradle", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defending Legs", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defending Legs Drill", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Defense", "Defending Legs to Cradle", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defending Tight Waist", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Defense", "Defending Tight Waist Drill", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Defense", "Fighting Off Back", null, { s: "INSTRUCTION" }],
  ...
  ["Bottom Position", "Bottom - Escapes & Reversals", "Bottom Drills", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "First Move Drills", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Granby Drills", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Hand Fighting to Escape", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Hip Heist", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Hip Heist Drills", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Hips Away Sit Out", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Peterson Roll", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Push Back Sit-Out", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Sit & Switch", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Sit-Out", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Stand Up", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Stand-Up", null, { s: "INSTRUCTION" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Stand-Up Drills", null, { s: "DRILL" }],
  ["Bottom Position", "Bottom - Escapes & Reversals", "Standing Switch", null, { s: "INSTRUCTION" }],
  // ===================== GAMES =====================
  ...
  ["Games", "Games", "Capture the Shoe", null, { s: "GAME" }],
  // ===================== LIVE WRESTLING =====================
  ...
  ["Live Wrestling", "Live Wrestling", "A-B-C's", null, { s: "LIVE" }],
  ["Live Wrestling", "Live Wrestling", "Bottom Only", ["Return back to Bottom Position after each Escape or Reversal"], { s: "LIVE" }],
  ["Live Wrestling", "Live Wrestling", "Groups of 4", null, { s: "LIVE" }],
  ["Live Wrestling", "Live Wrestling", "Situations", null, { s: "LIVE" }],
  ["Live Wrestling", "Live Wrestling", "Top - Bottom - Out", null, { s: "LIVE" }],
  ["Live Wrestling", "Live Wrestling", "Top Only", ["Return back to Top Position after each Escape or Reversal"], { s: "LIVE" }],
];
